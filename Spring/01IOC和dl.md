...
![image-20220920090852580](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\image-20220920090852580-16636361402811.png)



总结一下,为什么Javabean默认为单例模式

第一,避免了javabean的频繁产生和销毁,达到了bean对象的复用，性能高

第二避免了线程安全问题

Javabean请求线程共用了一个bean,所以会存在线程安全问题
...
。简单理解**有状态bean**就是在该bean创建的时候会携带一些特有的信息，这些信息会在程序执行时发生变动。

而**无状态bean**就是在创建该bean时，他的状态就确定了，在后续的生命周期中不会发生变化。最简单的无状态bean就是没有任何字段的bean。spring boot中我们开发的controller、service、等基本上都是无状态bean。

他们的特点是：只有方法，没有全局属性。我们定义的变量都在函数体内，这样的变量是每一个线程都会在自己的线程中创建不会共享的。所以这样的bean是线程安全的。
...
![image-20220920095429152](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\image-20220920095429152-16636388706533.png)
...
![1629775972507](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629775972507.png)
...
![1629775972507](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629775972507-16636393523636.png)
...
![1629776331499](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629776331499.png)
...
![1629786862329](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629786862329.png)
...
![image-20210729195248948](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\image-20210729195248948.png)
...
![1629786862329](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629786862329-166364049666411.png)
...
![1629788036885](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629788036885.png)
...
![1629788769436](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629788769436.png)
...
* 调用对象中的方法来创建bean，对应的是第二行配置
  ...
  * factory-method:工厂对象中的具体创建对象的方法名,对应关系如下:
    ...
    ![image-20210729200203249](C:/Users/Yilin.Yang/Desktop/Java资料/spring基础框架8笔记/Spring笔记/spring_day01/assets/image-20210729200203249.png)
...
![1629788769436](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629788769436-166364107937015.png)
...
![1629788769436](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629788769436-166364114158417.png)
...
![1629790070607](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629790070607.png)
...
![1629790197860](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629790197860.png)
...
![1629790197860](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629790197860-166364175335821.png)
...
![1629791473409](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629791473409.png)
...
![1629792339889](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629792339889.png)
...
* 运行程序，就能执行destroy方法的内容
  ...
  ![1629792857608](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629792857608.png)
...
* 运行后，查询打印结果
  ...
  ![1629792857608](C:/Users/Yilin.Yang/Desktop/Java资料/spring基础框架8笔记/Spring笔记/spring_day01/assets/1629792857608.png)
...
* 运行后，查询打印结果
  ...
  ![1629792857608](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629792857608-166364293307726.png)
...
![1629794527419](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629794527419.png)
...
* 思考:afterPropertiesSet和setBookDao谁先执行?
  ...
  * 重新运行AppForLifeCycle，打印结果如下:
    ...
    ![1629794928636](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629794928636.png)
...
![1629799214191](C:\Users\Yilin.Yang\Desktop\学习记录(笔记)\springLearn\allPicture\1629799214191.png)
...
![image-20220920131240312](allPicture/image-20220920131240312.png)
...
![1629800324721](allPicture/1629800324721.png)
...
![1629800748639](allPicture/1629800748639.png)
...
![1629802656916](allPicture/1629802656916.png)
...
![1629802697318](allPicture/1629802697318.png)
...
![1629803111769](allPicture/1629803111769.png)

上面已经完成了构造函数注入的基本使用，但是会存在一些问题:

![1629803529598](allPicture/1629803529598.png)
...
![1629805387647](allPicture/1629805387647.png)
...
- 按照名称注入中的名称指的是什么?
  ...
  ![1629806856156](allPicture/1629806856156-166365575639940.png)
...
![1629807579330](allPicture/1629807579330.png)
...
![1629808046783](allPicture/1629808046783.png)
