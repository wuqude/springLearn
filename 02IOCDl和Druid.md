...
这一节中，我们将通过一个案例来学习下对于第三方bean该如何进行配置管理。
...
* 创建一个Maven项目
  ...
  ![1629860338328](allPicture/1629860338328.png)
...
![1629887733081](allPicture/1629887733081.png)
...
* 从mvn的仓库`https://mvnrepository.com/`中进行搜索
  ...
  ![1629888540286](allPicture/1629888540286.png)
...
![1629889170229](allPicture/1629889170229.png)
...
![1629903845404](allPicture/1629903845404.png)
...
![1629975492444](allPicture/1629975492444.png)
...
* 问题一:键值对的key为`username`引发的问题
  ...
  ![1629975934694](allPicture/1629975934694.png)
...
#### 1.2.3 加载properties文件小结
  ...
  * 如何开启`context`命名空间
    ...
    ![1629980280952](allPicture/1629980280952.png)
...
![1629982672522](allPicture/1629982672522.png)
...
![1629983245121](allPicture/1629983245121.png)
...
![1629990315619](allPicture/1629990315619.png)
...
![1630027590558](allPicture/1630027590558.png)
...
![1630027743910](allPicture/1630027743910.png)
...
![1630028345074](allPicture/1630028345074.png)
...
![1630029110506](allPicture/1630029110506.png)

至此，纯注解开发的方式就已经完成了，主要内容包括:

* Java类替换Spring核心配置文件

  ![1630029254372](allPicture/1630029254372.png)
...
@Compononet是用来替换**bean**配置项的,拥有这个注解,就不用在xml文件当中写bean,除此之外还有`@Controller/@Service/@Repository`用于标识**bean**配置项,不同于@Component在于好记录那个层次

@Configuration是配置项,用来替换掉原先的`applicationContext.xml`文件
...
![1630031112993](allPicture/1630031112993.png)

#### 3.3.2 Bean的作用范围

(1)先运行App类,在控制台打印两个一摸一样的地址，说明默认情况下bean是单例

![image-20220921114347881](allPicture/image-20220921114347881.png)
...
再次执行App类，打印结果:![image-20220921133545644](allPicture/image-20220921133545644.png)
...
![image-20220921135154087](allPicture/image-20220921135154087.png)
...
![image-20220921135632280](allPicture/image-20220921135632280.png)
...
- #### 3.4.1 环境准备
  ...
  ![1630033604129](allPicture/1630033604129.png)

  环境准备好后，运行后会发现有问题

  ![1630033710052](allPicture/1630033710052.png)
...
![image-20220921142620511](allPicture/image-20220921142620511.png)
...
* 分析下面这种情况是否能完成注入呢?
  ...
  ![image-20220921143853971](allPicture/image-20220921143853971.png)
...
![1630084683663](allPicture/1630084683663.png)
...
![1630122466404](allPicture/1630122466404.png)
...
![1630125475609](allPicture/1630125475609.png)
...
![1630134786448](allPicture/1630134786448.png)
